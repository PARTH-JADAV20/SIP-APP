...
export default function SWPCalculator({ code, navHistory }) {
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                fullWidth
                helperText="Total amount invested initially"
                InputProps={{
                  sx: {
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                fullWidth
                helperText="Amount to withdraw regularly"
                InputProps={{
                  sx: {
                    backgroundColor: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                  }
              ...
              <Card sx={{
                ...
                <CardContent sx={{ p: 0 }}>
                  <Grid container spacing={2}>
                    {[
                      { label: 'Initial Investment', value: formatCurrency(result.initialInvestment), color: '#4E5340' },
                      { label: 'Total Withdrawn', value: formatCurrency(result.totalWithdrawn), color: '#697268' },
                      { label: 'Final Corpus', value: formatCurrency(result.finalCorpus), color: result.finalCorpus >= 0 ? '#95A3A4' : '#ff4444' },
                      { label: 'Total Withdrawals', value: result.totalWithdrawals, color: '#B7D1DA' },
                      { label: 'SWP Duration', value: `${result.durationMonths} months`, color: '#4E5340' },
                      { label: 'Annualized Return', value: `${Number(result.annualizedReturn).toFixed(2)}%`, color: result.annualizedReturn >= 0 ? '#697268' : '#ff4444' }
                    ].map((item, index) => (
                        ...
                        >
                          ...
                          <Tooltip 
                            formatter={(value, name) => {
                              ...
                              if (name === 'withdrawal') return [formattedValue, 'Withdrawal Amount'];
